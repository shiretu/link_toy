...
file2.o: file2.cpp
	clang++ -std=gnu++20 -g -Wall -Wextra -Wcast-align -Wformat=2 -Werror -Wfatal-errors -Wno-unused-parameter -Winit-self -Werror=type-limits  -pthread -fno-omit-frame-pointer -o file2.o -c file2.cpp

main.o: main.cpp
	clang++ -std=gnu++20 -g -Wall -Wextra -Wcast-align -Wformat=2 -Werror -Wfatal-errors -Wno-unused-parameter -Winit-self -Werror=type-limits  -pthread -fno-omit-frame-pointer -o main.o -c main.cpp
